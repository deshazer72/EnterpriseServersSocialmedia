$(document).ready(function() {
    ...
    if(params.userID != undefined){
     strAfterForm.html('<input type="hidden" id="profileUserID" value="' + params.userID + '">'); 
    }
    $('#textarea').focus(); 
    var text_max = 140;
...
function updateFunction(id){
    var textArea = $('#'+id).val(); 
    var strAfterForm = $('#afterForm'); 
    var strUserID = $('#profileUserID').val(); 
     ...
     if(textArea == "" || textArea == null){
        ...
        $.ajax({
            ...
            success: function(ouput){ 
                  window.location.href = "userprofile.php?userID=" + strUserID; 
            },
